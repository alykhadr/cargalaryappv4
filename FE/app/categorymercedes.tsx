    ...
    return (
        <SafeAreaView style={[styles.area, { backgroundColor: colors.background }]}>
            <View style={[styles.container, { backgroundColor: colors.background }]}>
                <HeaderWithSearch title="Mercedes-Benz" icon={icons.search} onPress={() => navigation.navigate("search")} />
...
export default CategoryMercedes;
