...
import { Alert, FlatList, Image, Modal, ScrollView, StyleSheet, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native';
                    ...
                    <View>
                        ...
                        <View style={[styles.inputContainer, {
                            ...
                            <TextInput
                                ...
                                onChangeText={(t: string) => { phoneInputRef.current = t; }}
                            />
                        </View>
                    </View>
                </ScrollView>
