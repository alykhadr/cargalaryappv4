...
interface ReviewCardProps {
  avatar: any; // Adjust the type according to your image source (e.g., ImageSourcePropType)
  name: string;
  description: string;
  avgRating: number;
  date: string; // Assuming date is a string in a format usable by getTimeAgo
  numLikes: number;
}
