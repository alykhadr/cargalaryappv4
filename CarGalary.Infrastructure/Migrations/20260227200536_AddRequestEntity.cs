        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_LookupDetails_CityId",
                        column: x => x.CityId,
                        principalTable: "LookupDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_LookupDetails_PaymentMethod",
                        column: x => x.PaymentMethod,
                        principalTable: "LookupDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_LookupDetails_RegionId",
                        column: x => x.RegionId,
                        principalTable: "LookupDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_LookupDetails_VehicleOwnerType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_PaymentMethod",
                table: "Requests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_VehicleOwnerType",
                table: "Requests",
