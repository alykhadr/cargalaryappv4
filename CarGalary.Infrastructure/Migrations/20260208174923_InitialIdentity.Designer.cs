...
namespace CarGalary.Infrastructure.Migrations
{
    ...
    [Migration("20260208174923_InitialIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.UserFavorite", b =>
                {
                    ...
                    b.HasOne("CarGalary.Domain.Entities.User", "User")
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("CarGalary.Domain.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("CarGalary.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
