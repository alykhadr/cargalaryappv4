        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhatsUpNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Latitute = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OurMissionAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OurMissionEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OurGoalsAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OurGoalsEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                name: "ContactSalesOfficers",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContactValue = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsMobileNo = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: false, defaultValue: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactSalesOfficers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OfferImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfferNameAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OfferNameEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DescriptionAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DescriptionEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DayAr = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DayEn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WorkingFrom = table.Column<int>(type: "int", nullable: true),
                    WorkingTo = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BranchWorkingDays_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPercentage = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                name: "AudioAndCommunicationSystems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AudioAndCommunicationSystems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AudioAndCommunicationSystems_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarCarFeatures", x => new { x.CarId, x.CarFeatureId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarGalleryImages", x => x.ImageId);
                    table.ForeignKey(
                        name: "FK_CarGalleryImages_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EaseAndComforts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EaseAndComforts_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EngineSpecifications_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExtraFeatures_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Measurements_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFavorites_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AudioAndCommunicationSystems_CarId",
                table: "AudioAndCommunicationSystems",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_BranchWorkingDays_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarGalleryImages_CarId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EaseAndComforts_CarId",
                table: "EaseAndComforts",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_EngineSpecifications_CarId",
                table: "EngineSpecifications",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_Exteriors_CarId",
                table: "Exteriors",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_ExtraFeatures_CarId",
                table: "ExtraFeatures",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_Measurements_CarId",
                table: "Measurements",
                column: "CarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Safeties_CarId",
                table: "Safeties",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_Seatings_CarId",
                table: "Seatings",
                column: "CarId");
