...
namespace CarGalary.Infrastructure.Migrations
{
    ...
    [Migration("20260629114330_AllowMultipleRequestsPerUser")]
    partial class AllowMultipleRequestsPerUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.Car", b =>
                {
                    ...
                    b.Property<decimal>("FuelTankCapacityLiter")
                    ...
                    b.Property<string>("WeelSizeInch")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.CarColor", b =>
                {
                    ...
                    b.Property<decimal?>("PricePefore")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.Invoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.InvoiceDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.Packages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.PrivacyPolicy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.UserRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsProductReview")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("IsAvailable", "IsProductReview", "CreatedAt");

                    b.ToTable("UserRates", t =>
                        {
                            t.HasCheckConstraint("CK_UserRates_RateValue", "[RateValue] >= 1 AND [RateValue] <= 5");
                        });
                });
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("CarGalary.Domain.Entities.Department", "Department")
                        .WithMany("Employees")
                    ...
                    b.HasOne("CarGalary.Domain.Entities.ApplicationUser", "User")
                        .WithOne("Employee")
                        .HasForeignKey("CarGalary.Domain.Entities.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.InvoiceDetail", b =>
                {
                    ...
                    b.HasOne("CarGalary.Domain.Entities.Invoice", "Invoice")
                        .WithMany("Details")
            ...
            modelBuilder.Entity("CarGalary.Domain.Entities.Request", b =>
                {
                    ...
                    b.HasOne("CarGalary.Domain.Entities.LookupDetails", "CityLookup")
                        .WithMany()
                    ...
                    b.HasOne("CarGalary.Domain.Entities.LookupDetails", "RegionLookup")
                        .WithMany()
                    ...
                    b.HasOne("CarGalary.Domain.Entities.LookupDetails", "VehicleOwnerTypeLookup")
                        .WithMany()
                        .HasForeignKey("VehicleOwnerType")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
