...
namespace CarGalary.Admin.Api.Controllers
{
    ...
    public class ContactSalesOfficerController : ControllerBase
    {
        ...
        private const string ContactSalesNotFoundCode = "1305";
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            if (item == null) return NotFound(new ApiErrorResponse(ContactSalesNotFoundCode, StatusCodes.Status404NotFound));
            return Ok(item);
        }
            ...
            [FromServices] IValidator<UpdateContactSalesOfficerRequestDto> validator)
        {
            ...
            if (existing == null) return NotFound(new ApiErrorResponse(ContactSalesNotFoundCode, StatusCodes.Status404NotFound));
            ...
            {
                return NotFound(new ApiErrorResponse(ContactSalesNotFoundCode, StatusCodes.Status404NotFound));
            }
        }
