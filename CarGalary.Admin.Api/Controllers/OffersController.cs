...
namespace CarGalary.Admin.Api.Controllers
{
    ...
    public class OffersController : ControllerBase
    {
        ...
        private const string OfferNotFoundCode = "1324";
        private const string OfferIdsRequiredCode = "1220";
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            if (item == null) return NotFound(new ApiErrorResponse(OfferNotFoundCode, StatusCodes.Status404NotFound));
            return Ok(item);
        }
            ...
            [FromServices] IValidator<UpdateOfferRequestDto> validator)
        {
            ...
            if (existing == null) return NotFound(new ApiErrorResponse(OfferNotFoundCode, StatusCodes.Status404NotFound));
            ...
            {
                return NotFound(new ApiErrorResponse(OfferNotFoundCode, StatusCodes.Status404NotFound));
            }
        }
        ...
        public async Task<IActionResult> BulkDelete([FromBody] BulkDeleteOfferRequest request)
        {
            ...
            {
                return BadRequest(new ApiErrorResponse(OfferIdsRequiredCode, StatusCodes.Status400BadRequest));
            }
