...
{
    public class UpdateEngineSpecificationRequestValidator : AbstractValidator<UpdateEngineSpecificationRequestDto>
    {
        public UpdateEngineSpecificationRequestValidator()
        {
