...
{
    public class CreateCompanyInformationRequestValidator : AbstractValidator<CreateCompanyInformationRequestDto>
    {
        public CreateCompanyInformationRequestValidator()
        {
            ...
            RuleFor(x => x.LogoFile).NotNull().WithMessage("LogoFile is required");
