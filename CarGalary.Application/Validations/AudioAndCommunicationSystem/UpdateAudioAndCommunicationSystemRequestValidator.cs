...
{
    public class UpdateAudioAndCommunicationSystemRequestValidator : AbstractValidator<UpdateAudioAndCommunicationSystemRequestDto>
    {
        public UpdateAudioAndCommunicationSystemRequestValidator()
        {
            RuleFor(x => x.NameEn)
