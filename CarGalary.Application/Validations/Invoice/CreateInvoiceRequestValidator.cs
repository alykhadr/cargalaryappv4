...
namespace CarGalary.Application.Validations.Invoice
{
    public class CreateInvoiceRequestValidator : AbstractValidator<CreateInvoiceRequestDto>
    {
        public CreateInvoiceRequestValidator()
        {
            ...
            RuleForEach(x => x.Details).SetValidator(new CreateInvoiceDetailRequestValidator());
        }
    }

    public class CreateInvoiceDetailRequestValidator : AbstractValidator<CreateInvoiceDetailRequestDto>
    {
